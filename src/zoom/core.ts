...
export default class Zoom {
    ...
    public methodSigPointers:any = [];
    private addressInAnyResultCache: any = {};
     ...
     */
     public generateBinaryCalls() {
        ...
        Object.keys(this.cache).forEach((call) => {
            ...
            const identifier = CryptoJS.MD5(_key).toString();
     ...
     */
     public addResultReferenceCall(_contract:any, _methodAndParams: any, resultIndex: number, _fullSig: any) {
        ...
        const oldidentifier = CryptoJS.MD5(_key).toString();
        const identifier = CryptoJS.MD5(_newkey).toString();
        this.calls[_newkey] = "";
